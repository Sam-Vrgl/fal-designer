...
- [x] Ajouter toutes les insignes BAC
- [x] Ajouter toutes les insignes de filières
- [ ] Ajouter toutes les insignes options (international, drapeaux etc)
- [x] Ajouter Helper pour les cursus multidisciplinaires et particuliers (PASS, LASS, prépa etc)
